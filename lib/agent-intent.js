 ...
 * @typedef {'score_resume'|'optimize_resume'|'prep_interview'|'next_scenario'|'switch_tab'|'export_doc'|'navigate_scene'|'coach_mode'|'coach_followup'|'goal_plan'|'submit_scenario'|'refine_canvas'} AgentIntentName
 */
